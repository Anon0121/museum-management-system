-- Consolidate Visitor System
-- This script creates a unified visitor system with proper booking types and primary visitor indicators
...
-- ========================================
-- 3. MIGRATE DATA FROM ADDITIONAL_VISITORS
-- ========================================
...
-- If additional_visitors table exists, migrate the data
